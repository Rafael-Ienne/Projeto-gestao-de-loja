		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aprovar solicitação de mudança de preço",
									"targetURL": "#desafioabap85aprovarsolicitacao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"desafioabap85aprovarsolicitacao-display": {
								"semanticObject": "desafioabap85aprovarsolicitacao",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=desafioabap85.aprovarsolicitacao",
									"url": sap.ui.require.toUrl("desafioabap85/aprovarsolicitacao")
								}
							}
						}
					}
